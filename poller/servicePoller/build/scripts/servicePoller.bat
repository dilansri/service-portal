...
set CLASSPATH=%APP_HOME%\lib\servicePoller-1.0.0-SNAPSHOT.jar;%APP_HOME%\lib\vertx-config-4.0.3.jar;%APP_HOME%\lib\vertx-web-client-4.0.3.jar;%APP_HOME%\lib\vertx-rx-java2-4.0.3.jar;%APP_HOME%\lib\vertx-pg-client-4.0.3.jar;%APP_HOME%\lib\vertx-rx-java2-gen-4.0.3.jar;%APP_HOME%\lib\vertx-rx-gen-4.0.3.jar;%APP_HOME%\lib\vertx-codegen-4.0.3.jar;%APP_HOME%\lib\vertx-web-common-4.0.3.jar;%APP_HOME%\lib\vertx-auth-common-4.0.3.jar;%APP_HOME%\lib\vertx-sql-client-4.0.3.jar;%APP_HOME%\lib\vertx-core-4.0.3.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.60.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.60.Final.jar;%APP_HOME%\lib\netty-handler-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.60.Final.jar;%APP_HOME%\lib\netty-codec-4.1.60.Final.jar;%APP_HOME%\lib\netty-transport-4.1.60.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.60.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.60.Final.jar;%APP_HOME%\lib\netty-common-4.1.60.Final.jar;%APP_HOME%\lib\jackson-core-2.11.3.jar;%APP_HOME%\lib\rxjava-2.2.12.jar;%APP_HOME%\lib\reactive-streams-1.0.3.jar
